...
title-slide-attributes:
    data-background-image: trend2.png
...
Vi skal i MPS140 repetere elementære statistikk og så utvide til multippel regresjon og faktormodeller. Her er noen nye ting vi skal lære:
...
-   lære om måling av psykologiske begrep som stress, lojalitet, trivsel etc (i R)
:::
